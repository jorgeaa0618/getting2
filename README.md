...
2. Organizing and combining raw data sets into single one.
...
6.Organizing and combining all data sets into single one.
7. Defining descriptive names for all variables.
